...
from brainreg_manual_seg.layout.gui_elements import (
    add_button,
    add_checkbox,
    add_float_box,
    add_int_box,
...
from brainreg_manual_seg.layout.gui_utils import (
    disable_napari_btns,
    disable_napari_key_bindings,
)

from brainreg_manual_seg.layout.gui_constants import WINDOW_HEIGHT, WINDOW_WIDTH, COLUMN_WIDTH
